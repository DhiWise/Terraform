class PostOrganizationsResp {
  Data? data;
  List<Included>? included;

  PostOrganizationsResp({this.data, this.included});

  PostOrganizationsResp.fromJson(Map<String, dynamic> json) {
...
class Attributes {
  ...
  bool? costEstimation;
  bool? configurationDesigner;
  bool? operations;
  bool? privateModuleRegistry;
  bool? sentinel;
  bool? stateStorage;
  bool? teams;
  bool? vcsIntegrations;
  bool? usageReporting;
  double? userLimit;
  bool? selfServeBilling;
  bool? viewableBilling;
  bool? auditLogging;
  bool? agents;
  bool? sso;
  bool? runTasks;
  ...
  Attributes(
      ...
      this.costEstimation,
      this.configurationDesigner,
      this.operations,
      this.privateModuleRegistry,
      this.sentinel,
      this.stateStorage,
      this.teams,
      this.vcsIntegrations,
      this.usageReporting,
      this.userLimit,
      this.selfServeBilling,
      this.viewableBilling,
      this.auditLogging,
      this.agents,
      this.sso,
      this.runTasks,
  ...
  Attributes.fromJson(Map<String, dynamic> json) {
    ...
    costEstimation = json['cost-estimation'];
    configurationDesigner = json['configuration-designer'];
    operations = json['operations'];
    privateModuleRegistry = json['private-module-registry'];
    sentinel = json['sentinel'];
    stateStorage = json['state-storage'];
    teams = json['teams'];
    vcsIntegrations = json['vcs-integrations'];
    usageReporting = json['usage-reporting'];
    userLimit = json['user-limit'];
    selfServeBilling = json['self-serve-billing'];
    viewableBilling = json['viewable-billing'];
    auditLogging = json['audit-logging'];
    agents = json['agents'];
    sso = json['sso'];
    runTasks = json['run-tasks'];
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.costEstimation != null) {
      data['cost-estimation'] = this.costEstimation;
    }
    if (this.configurationDesigner != null) {
      data['configuration-designer'] = this.configurationDesigner;
    }
    if (this.operations != null) {
      data['operations'] = this.operations;
    }
    if (this.privateModuleRegistry != null) {
      data['private-module-registry'] = this.privateModuleRegistry;
    }
    if (this.sentinel != null) {
      data['sentinel'] = this.sentinel;
    }
    if (this.stateStorage != null) {
      data['state-storage'] = this.stateStorage;
    }
    if (this.teams != null) {
      data['teams'] = this.teams;
    }
    if (this.vcsIntegrations != null) {
      data['vcs-integrations'] = this.vcsIntegrations;
    }
    if (this.usageReporting != null) {
      data['usage-reporting'] = this.usageReporting;
    }
    if (this.userLimit != null) {
      data['user-limit'] = this.userLimit;
    }
    if (this.selfServeBilling != null) {
      data['self-serve-billing'] = this.selfServeBilling;
    }
    if (this.viewableBilling != null) {
      data['viewable-billing'] = this.viewableBilling;
    }
    if (this.auditLogging != null) {
      data['audit-logging'] = this.auditLogging;
    }
    if (this.agents != null) {
    ...
    if (this.runTasks != null) {
      data['run-tasks'] = this.runTasks;
    }
...
class Included {
  ...
  Included({this.id, this.type, this.attributes, this.links});
